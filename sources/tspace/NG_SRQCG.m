...
%
% This function computes the smallest eigenpairs of the generalized eigenproblem:
%
% A*x = lambda*M*x
%
% Input variables:
...
% Prec       function handle representing the preconditioner application (M*x)
...
function [Zk,qk,iter,resid] = NG_SRQCG(V0,ProdMat,Prec,itmax,tol,ritz_freq, VERBOSE)
