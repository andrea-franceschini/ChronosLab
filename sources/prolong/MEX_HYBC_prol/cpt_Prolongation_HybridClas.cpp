...
#include "mex.h"
#include "HybridClas_prolongation.h"


int cpt_Prolongation_HybridClas(const int level, const int nthreads,
   ...
   ierr = HybridClas_prolongation(level,nthreads,vecstart,nn_A,nt_A,iat_A,ja_A,
                  ...
                  int nrhs, const mxArray *prhs[])
{
   ...
   int *iat_I,*ja_I;
   double *coef_I;
   int ierr = cpt_Prolongation_HybridClas(level,np,vecstart,nn_A,nt_A,iat_A,ja_A,coef_A,
