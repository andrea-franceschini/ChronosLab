function mat_I = cpt_ProlMEX_HybridClas(params,nn_C,fcnodes,mat_S,mat_A)
%------------------------------------------------------------------------------------------
%
% Computes the prolongation using the Hybrid-Classical algorithm
%
...
[nt_I,iat_I,ja_I,coef_I] = cpt_Prolongation_HybridClas(level,np,...
